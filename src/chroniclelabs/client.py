...
if typing.TYPE_CHECKING:
    ...
    from .timeline.client import AsyncTimelineClient, TimelineClient
...
class Chronicle:
    ...
    environment : ChronicleEnvironment
        The environment to use for requests from the client. from .environment import ChronicleEnvironment



        Defaults to ChronicleEnvironment.PRODUCTION
    ...
    def __init__(
        ...
        *,
        ...
        environment: ChronicleEnvironment = ChronicleEnvironment.PRODUCTION,
        token: typing.Union[str, typing.Callable[[], str]],
        ...
        self._timeline: typing.Optional[TimelineClient] = None
    ...
    def timeline(self):
        if self._timeline is None:
            ...
            self._timeline = TimelineClient(client_wrapper=self._client_wrapper)
    ...
    def discover(self):
        if self._discover is None:
            ...
            self._discover = DiscoverClient(client_wrapper=self._client_wrapper)
...
class AsyncChronicle:
    ...
    def __init__(
        ...
        *,
        ...
        self._timeline: typing.Optional[AsyncTimelineClient] = None
    ...
    def timeline(self):
        if self._timeline is None:
            ...
            self._timeline = AsyncTimelineClient(client_wrapper=self._client_wrapper)
        return self._timeline
    ...
    def discover(self):
        if self._discover is None:
            ...
            self._discover = AsyncDiscoverClient(client_wrapper=self._client_wrapper)
        return self._discover
