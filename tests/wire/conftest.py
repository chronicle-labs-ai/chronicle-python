...
from chroniclelabs.client import Chronicle

# Check once at import time whether the client constructor accepts a headers kwarg.
try:
    _CLIENT_SUPPORTS_HEADERS: bool = "headers" in inspect.signature(Chronicle).parameters
...
def get_client(test_id: str) -> Chronicle:
    """
